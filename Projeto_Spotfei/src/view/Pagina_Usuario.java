...
import control.ControllerHistorico;
...
public class Pagina_Usuario extends javax.swing.JFrame {
    ...
    private void btn_historyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_historyActionPerformed
        ...
        h.getLista_historico().setFixedCellHeight(30);
        h.getLista_likes().setFixedCellHeight(30);
        h.getLista_dislike().setFixedCellHeight(30);
        c.exibirHistorico(h.getLista_historico());
        c.exibirLikes(h.getLista_likes());
        c.exibirDislikes(h.getLista_dislike());
        h.setVisible(true);
        this.setVisible(false);
